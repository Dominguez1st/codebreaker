 ...
 * the number of characters in the correct position, and the number of addition charters that
 * are in the secret code and the guess, but are not in the correct positions in the guess.
 *
 * @version 1.0
